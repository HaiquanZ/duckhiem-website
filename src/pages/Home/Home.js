    ...
    <div className="Home">
      <div className="row first">
        <div className="first_text col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
          ...
          <a href="#discoverid" className="button">
            Get Started
          </a>
        </div>
        <img
          ...
          alt="intro"
          src="https://i.imgur.com/2rJbhuX.jpg"
        />
      </div>
      ...
      <div className="describe">
        ...
        <h2 style={{ fontWeight: "lighter" }}>
          ...
          <br />
          There will be times when I want to look back my journey. Thanks for
          visiting!
        </h2>
      </div>
      ...
      <div className="discover row" id="discoverid">
        ...
        <a
          href="https://www.youtube.com/channel/UCP6s9D_9RC6mUqNEj2JjHJA"
          className="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3"
        >
          <div className="item_discover">
