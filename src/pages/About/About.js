    ...
    return(
        <div className="About">
            ...
            <div className="infor row">
                <img className="infor_img col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6" alt="avatar" src="https://i.imgur.com/WR3TeAn.png"/>
                <div className="infor_text col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                    <h1>ABOUT ME</h1>
                    <h1 style={{marginBottom:'2rem'}}>I'm just an ordinary person and bla...bla...</h1>
            ...
            <div className="row cm">
                ...
                <div className="col-12 col-sm-12 col-md-5 col-lg-4 col-xl-3">
                    <div className="donate">
                        ...
                        <h2>Ăn xin online</h2>
                        <div className="wrap_btn">
                        <button onClick={handleShowAlert} className="button">Donate me</button>
                        </div >
                    </div>
